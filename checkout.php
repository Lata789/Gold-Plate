	...
	<form action="Payment.html" method="post">
		...
		<br>
			    ...
			    <tr align="center">
			    	...
			    	<td style="color: #ff0157">  Enter your name  <br>
			    ...
			    <tr align="center">
			    	<td style="color: #ff0157">   Enter Mobile no <br>
			    ...
			    <tr align="center">
			    	<td style="color: #ff0157">   Enter Email address <br>
                ...
                <tr align="center">
                	<td style="color: #ff0157"> Enter address <br>
