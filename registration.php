...
<body>
 ...
 <td> <input type="email" name="email" value="" placeholder="Enter Your Email Address" required="" style="padding: 10px; width: 300%">  <br> </td>
      ...
      <tr>   
<td align="center"> <input type="submit" name="sb" value="Registration Now" style="color:#ff0157; background: lightgreen; font-size: 1.3em; font-family: times new roman">  <br> </td>
   </tr>
